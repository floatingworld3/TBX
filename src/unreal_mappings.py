...
class UnrealMarker:
    def __init__(self, name, points, component, weight=1, inverted_percentage=False) -> None:
        self.points = points
...
class UnrealMapper:
    ...
    def __init__(self) -> None:
        ...
        self.add_marker(name="EyeBlinkLeft",point1="LeftEyeUpper1", point2="LeftEyeLower1", component="Y", inverted_percentage=True)
        ...
        self.add_marker(name="EyeLookOutLeft",point1="pupilpointL", point2="NoseBridge", component="X", inverted_percentage=True)
        self.add_marker(name="EyeLookUpLeft",point1="pupilpointL", point2="NoseBridge", component="Y",inverted_percentage=True)
        ...
        self.add_marker(name="EyeBlinkRight",point1="RightEyeUpper", point2="RightEyeLower1", component="Y",inverted_percentage=True)
        self.add_marker(name="EyeLookDownRight",point1="pupilpointR", point2="NoseBridge", component="Y")
        self.add_marker(name="EyeLookInRight",point1="pupilpointR", point2="NoseBridge", component="X",inverted_percentage=True)
        self.add_marker(name="EyeLookOutRight",point1="pupilpointR", point2="NoseBridge", component="X" , inverted_percentage=True)
        self.add_marker(name="EyeLookUpRight",point1="pupilpointR", point2="NoseBridge", component="Y",inverted_percentage=True)
        self.add_marker(name="EyeSquintRight",point1="RightEyeUpper", point2="RightEyebrow2Middle", component="Y",inverted_percentage=True)
        ...
        self.add_marker(name="MouthClose",point1="MouthTopInner2", point2="MouthTopInner1", component="Y",inverted_percentage=True)
        self.add_marker(name="MouthFunnel",point1="MouthLeft", point2="MouthRight", component="X", inverted_percentage=True)
        self.add_marker(name="MouthPucker",point1="MouthLet", point2="MouthRight", component="X", inverted_percentage=True)
        ...
        self.add_marker(name="MouthSmileleft",point1="MouthLeft", point2="NoseTip", component="Y", inverted_percentage=True)
        self.add_marker(name="MouthSmileRight",point1="MouthRight", point2="NoseTip", component="Y",inverted_percentage=True)
        ...
        self.add_marker(name="Mouthstretchright",point1="NoseTip", point2="MouthRight", component="X")
        ...
        self.add_marker(name="Mouthpressleft",point1="MouthLeftInnerLwr", point2="MouthLeftInner", component="Y",inverted_percentage=True)
        self.add_marker(name="Mouthpressright",point1="MouthRightInnerLwr", point2="MouthRightInner1", component="Y" ,inverted_percentage=True)
        ...
        self.add_marker(name="MouthUpperUpLeft",point1="MouthLeftTop", point2="NoseTip", component="Y",inverted_percentage=True)
        self.add_marker(name="MouthUpperUpright",point1="MouthRTop", point2="NoseTip", component="Y",inverted_percentage=True)
        self.add_marker(name="BrowDownLeft",point1="LeftEyebrowMiddle", point2="NoseBridge", component="Y", inverted_percentage=True)
        self.add_marker(name="BrowDownRight",point1="RightEyebrow2Middle", point2="NoseBridge", component="Y"  ,inverted_percentage=True)
        ...
        self.add_marker(name="CheekPuff",point1="", point2="", component="X")
        ...
        self.add_marker(name="NoseSneerLeft",point1="LeftNostril", point2="NoseTip", component="Y", inverted_percentage=True)
        self.add_marker(name="NoseSneerRight",point1="RightNostril", point2="NoseTip", component="Y", inverted_percentage=True)
    ...
    def add_marker(self, name, point1, point2, component, weight=1, inverted_percentage=False):
