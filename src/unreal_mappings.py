...
class UnrealMapper:
    ...
    def __init__(self) -> None:
        ...
        self.add_marker(name="Mouthstretchleft",point1="MouthLeft", point2="NoseTip", default_scale=5, component="X")
        self.add_marker(name="Mouthstretchright",point1="NoseTip", point2="MouthRight", default_scale=5, component="X")
        ...
        self.add_marker(name="TongueOut",point1="", point2="", default_scale=5, component="")
